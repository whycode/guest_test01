...
class ModelTest(TestCase):
    ...
    def setUp(self):
        ...
        Guest.objects.create(id=1, event_id=1, realname='alen', phonefom='13711001101', email='alen@mail.com',
                             sign=False)
...
class GuestManageTest(TestCase):
    ...
    def setUp(self):
        ...
        Guest.objects.create(realname="alen", phone=1861100100, email="alen@mail.com", sign=0, event_id=1)
        self.login_user = {'username': 'admin', 'password': 'admin123456'}
